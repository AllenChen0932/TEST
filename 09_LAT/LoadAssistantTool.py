...
import LoadSummaryTable as lct
...
class MainWindow(QMainWindow):
    ...
    def delete_run(self):
        self.delete_run = DeleteRun.DeleteWindow()
        self.delete_run.show()

    def copy_file(self):
        self.copy_file = Multi_Copy.CopyWindow()
        self.copy_file.show()

    def user_manual(self):
        os.startfile(os.getcwd()+os.sep+'user manual\Load Assistant Tool.docx')
