...
class Fatigue(object):
    ...
    def write_pj(self):
        ...
        for key, value in self.cha_dict.items():
            ...
            elif len(value) == 2 and len(value[0]) == 6:
                # write tr
                print(value)
                for sec in value[-1]:
                    # header
            ...
            elif len(value) == 1 and len(value[0]) == 6:
                # write hs, hr, yb
                # header
                content = '<?xml version="1.0" encoding="ISO-8859-1" ?>\n' \
                          '<BladedProject ApplicationVersion="4.8.0.41">\n' \
    ...
    def read_lct(self):
        ...
        if IEC_stand == '1':
            ...
            for dlc in self.dlc_list:
                ...
                ws = table[lc if not self.sec_num else '_'.join([lc, self.sec_num])]
