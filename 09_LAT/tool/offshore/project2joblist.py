...
class Offshore_Joblist(object):
    ...
    def __init__(self, run_path, dlc_list):

        self.run_path = run_path
        self.dlc_list = dlc_list

        self.dlc_lc_list = {}     #dlc: load cases(design load case under run path)
    ...
    def get_pj(self):
        ...
        for dlc in self.dlc_list:
            ...
            if os.path.isdir(dlc_path):
                ...
                self.dlc_lc_list[dlc] = [file for file in os.listdir(dlc_path) if
    ...
    def run(self):
        ...
        for dlc, lc_list in self.dlc_lc_list.items():
            # print(dlc, lc_list)
